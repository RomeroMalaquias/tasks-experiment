...
#ifdef CUSTOM_CHECK //Se CUSTOM_CHECK1 estiver definido e essa não, vai dar erro
/**
...
xmlNanoFTPGetConnection(void *ctx) {
	...
	/* ToDO Adicionar a função fnprintf com os paramêtros serão iguais a da chamada de função de sprintf, mas no lugar do adp[2] & 0xff ela recebe fnp[0] & 0xff e no lugar do portp[0] & 0xff recebe fnp[1] & 0xff. */
#ifndef HAVE_SNPRINTF
